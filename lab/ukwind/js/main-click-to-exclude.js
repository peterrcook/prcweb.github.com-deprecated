...
function init() {
  ...
  for(i = 0; i < windData.length; i++) {
    ...
    var lonLat1 = lonLatFromLonLatDistanceAndBearing(lonLat0, 2, cardinalToBearing[d.Period.Rep.D]);
    ...
    var line = {
      ...
      duration: 10000 / speed, /* pre-compute duration */
...
d3.json("data/uk.json", function(error, uk) {
  ...
  svg.selectAll('circle')
    ...
    .append("circle")
    .attr({
      cx: function(d) {return d.x0}, 
      cy: function(d) {return d.y0}
    })
  // .attr({
  //   x2: function(d) {return d.x1},
  //   y2: function(d) {return d.y1}
